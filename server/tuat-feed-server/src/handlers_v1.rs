...
mod test {
    ...
    async fn dummy_state() -> Arc<ServerState> {
        let academic = InfoBundle::new(vec![dummy_post(0), dummy_post(1)], Instant::now());
        let campus = InfoBundle::new(vec![dummy_post(10), dummy_post(11)], Instant::now());
    ...
    async fn check_json_formatting_index() {
        ...
        let correct_outputs = [dummy_post(0), dummy_post(1), dummy_post(10), dummy_post(11)]
            .into_iter()
            .map(Into::into)
            .collect::<Vec<_>>();
    ...
    async fn check_json_formatting_campus() {
        ...
        let correct_outputs = [dummy_post(10), dummy_post(11)]
            .into_iter()
            .map(Into::into)
            .collect::<Vec<_>>();
